...
static uint8_t worker_macs[NUM_WORKERS][6] = {
    {0x02, 0x00, 0x00, 0x00, 0x00, 0x01},  // Worker 1
    {0x02, 0x00, 0x00, 0x00, 0x00, 0x02},  // Worker 2
    {0x02, 0x00, 0x00, 0x00, 0x00, 0x03},  // Worker 3
    {0x02, 0x00, 0x00, 0x00, 0x00, 0x04},  // Worker 4
};
